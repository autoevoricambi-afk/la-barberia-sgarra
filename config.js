 ...
 * Dati operativi verificati per sito + prenotazioni a due postazioni.
 */
window.SITE_CONFIG = Object.freeze({
  /* Il dominio definitivo viene indicizzato solo dopo il collaudo e il puntamento DNS. */
  launchReady: false,
  ...
  barber: {
    ...
    bioNeutral: 'Dietro ogni lavoro cՏ Paolo Sgarra, titolare della Barberia Sgarra ad Andria. In barberia lavora anche Giuseppe, con agenda indipendente.'
  },
  ...
  media: {
    hero: {
      mode: 'image',
      poster: 'assets/images/studio/interno-02.webp',
      imageSrcset: 'assets/images/studio/interno-02.webp',
      imageFallback: 'assets/images/studio/interno-02.jpg',
      width: 960,
      height: 1280,
      videoMp4: '',
      videoWebm: ''
