...
import appointments from '../api/_routes/appointments.js';
import availability from '../api/_routes/availability.js';
import publicConfig from '../api/_routes/public-config.js';
import waitlist from '../api/_routes/waitlist.js';
...
import adminInventory from '../api/_routes/admin/inventory.js';
import adminWaitlist from '../api/_routes/admin/waitlist.js';
import adminMetrics from '../api/_routes/admin/metrics.js';
import processOutbox from '../api/_routes/cron/process-outbox.js';
